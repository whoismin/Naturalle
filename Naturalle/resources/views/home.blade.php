...
<body id="top">
  ...
  <header class="header" data-header>
    ...
    <article>
           ...
           <section class="hero text-center" aria-label="home" id="home">
            <ul class="hero-slider" data-hero-slider>
                <li class="slider-item active" data-hero-slider-item>
                    <div class="slider-bg">
                        <img src="{{ asset('assets/images/Salada.png') }}" width="1880" height="950" alt="" class="img-cover">
                    </div>
                ...
                <li class="slider-item" data-hero-slider-item>
                    <div class="slider-bg">
                        <img src="{{ asset('assets/images/Salada2.png') }}" width="1880" height="950" alt="" class="img-cover">
                    </div>
                ...
                <li class="slider-item" data-hero-slider-item>
                    <div class="slider-bg">
                        <img src="{{ asset('assets/images/Salada3.png') }}" width="1880" height="950" alt="" class="img-cover">
                    </div>
                ...
                <ul class="grid-list">
                        ...
                        <div class="service-card">
                            <a href="#" class="has-before hover:shine">
                                <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                    <img src="{{ asset('assets/images/Sobremesa1.jpg') }}" width="285" height="336" loading="lazy" alt="Sobremesas" class="img-cover">
                                </figure>
                            </a>
                    ...
                    <li>
                        <div class="service-card">
                            <a href="#" class="has-before hover:shine">
                                <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                    <img src="{{ asset('assets/images/prato1.jpg') }}" width="285" height="336" loading="lazy" alt="Pratos Principais" class="img-cover">
                                </figure>
                            </a>
                            <div class="card-content">
                                <h3 class="title-4 card-title">
                    ...
                    <li>
                        <div class="service-card">
                            <a href="#" class="has-before hover:shine">
                                <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                    <img src="{{ asset('assets/images/service-3.jpg') }}" width="285" height="336" loading="lazy" alt="Bebidas" class="img-cover">
                                </figure>
                            </a>
                            <div class="card-content">
                                <h3 class="title-4 card-title">
        ...
        <!-- FRASE IMPACTANTE -->
        <section class="section testi text-center has-bg-image" style="background-image: url('{{ asset('assets/images/fotter3.jpg') }}')" aria-label="testimonials">
            <div class="container">
                <div class="quote"></div>
        ...
        <ul class="grid-list">
            <li class="feature-item">
                <div class="feature-card">
                    <div class="card-icon">
                        <img src="{{ asset('assets/images/NGOIcon.png') }}" width="100" height="80" loading="lazy" alt="icon">
                    </div>
            ...
            <li class="feature-item">
                <div class="feature-card">
                    <div class="card-icon">
                        <img src="{{ asset('assets/images/Saladaicon.png') }}" width="100" height="80" loading="lazy" alt="icon">
                    </div>
            ...
            <li class="feature-item">
                <div class="feature-card">
                    <div class="card-icon">
                        <img src="{{ asset('assets/images/SustentavelIcon.png') }}" width="100" height="80" loading="lazy" alt="icon">
                    </div>
            ...
            <li class="feature-item">
                <div class="feature-card">
                    <div class="card-icon">
                        <img src="{{ asset('assets/images/ChefIcon.png') }}" width="100" height="80" loading="lazy" alt="icon">
                    </div>
