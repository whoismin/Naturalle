        ...
        <article>
            ...
            <section class="hero text-center" aria-label="home" id="home">
                <ul class="hero-slider" data-hero-slider>
                    <li class="slider-item active" data-hero-slider-item>
                        <div class="slider-bg">
                            <img src="{{ asset('assets/images/Salada.png') }}" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                    ...
                    <li class="slider-item" data-hero-slider-item>
                        <div class="slider-bg">
                            <img src="{{ asset('assets/images/Salada2.png') }}" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                    ...
                    <li class="slider-item" data-hero-slider-item>
                        <div class="slider-bg">
                            <img src="{{ asset('assets/images/Salada3.png') }}" width="1880" height="950" alt=""
                                class="img-cover">
                        </div>
                ...
                <a href="#" class="hero-btn has-after">
                    <img src="{{ asset('assets/images/VeganIcon.png') }}" width="75" height="75" alt="booking icon">
                ...
                <div class="container">
                    <div class="about-content">
                        ...
                        <p class="section-text">
                            A Naturalle é um restaurante vegano e vegetariano que não apenas oferece alimentos de
                            qualidade e confiáveis, mas também contém um projeto socioambiental chamado 'Sabor
                            Solidário' em parceria com diversas ONGs
                        </p>
                    ...
                    <figure class="about-banner">
                        ...
                        <div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
                            <img src="{{ asset('assets/images/about-abs-image.jpg') }}" width="285" height="285"
            ...
            <section class="special-dish text-center" aria-labelledby="dish-label">
                ...
                <div class="special-dish-content bg-black-10">
                    <div class="container">
                        <img src="{{ asset('assets/images/badge-1.png') }}" width="28" height="41" loading="lazy"
                        ...
                        <p class="section-text">
                            O projeto tem um impacto ambiental positivo ao fornecer refeições veganas e vegetarianas
                            para pessoas em situações de vulnerabilidade. Isso não apenas melhora a qualidade de vida
                            dos indivíduos em vários aspectos, mas também beneficia o meio ambiente, uma vez que tanto o
                            veganismo quanto o vegetarianismo compartilham o objetivo comum de melhorar a qualidade de
                            vida sem prejudicar o ecossistema.
                        </p>
            ...
            <section class="section service bg-White text-center" aria-label="menu">
                <div class="container">
                    ...
                    <p class="section-text">
                        Na Naturalle, a culinária se transforma em magia. Cada prato é uma poção de sabores e amor,
                        criando memórias encantadoras em cada refeição.
                    </p>
                    <ul class="grid-list">
                        <li>
                            <div class="service-card">
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('assets/images/Sobremesa1.jpg') }}" width="285" height="336"
                                            loading="lazy" alt="Sobremesas" class="img-cover">
                                    </figure>
                                </a>
                        ...
                        <li>
                            <div class="service-card">
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('assets/images/prato1.jpg') }}" width="285" height="336"
                                            loading="lazy" alt="Pratos Principais" class="img-cover">
                                    </figure>
                                </a>
                                <div class="card-content">
                                    <h3 class="title-4 card-title">
                        ...
                        <li>
                            <div class="service-card">
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('assets/images/service-3.jpg') }}" width="285" height="336"
                                            loading="lazy" alt="Bebidas" class="img-cover">
                                    </figure>
                                </a>
                                <div class="card-content">
                                    <h3 class="title-4 card-title">
                    ...
                    <img src="{{ asset('assets/images/shape-1.png') }}" width="246" height="412" loading="lazy"
                        alt="shape" class="shape shape-1 move-anim">
                    <img src="{{ asset('assets/images/shape-2.png') }}" width="343" height="345" loading="lazy"
            ...
            <section class="section testi text-center has-bg-image"
                style="background-image: url('{{ asset('assets/images/fotter3.jpg') }}')" aria-label="testimonials">
                <div class="container">
                    <div class="quote"></div>
                    ...
                    <ul class="grid-list">
                        <li class="feature-item">
                            <div class="feature-card">
                                <div class="card-icon">
                                    <img src="{{ asset('assets/images/NGOIcon.png') }}" width="100" height="80"
                                        loading="lazy" alt="icon">
                                </div>
                                <h3 class="title-2 card-title">Impacto Social Positivo</h3>
                                <p class="label-1 card-text">Alimente o seu corpo e faça o bem ao mesmo tempo. Cada
                                    refeição na Naturalle contribui para causas sociais importantes.</p>
                            </div>
                        </li>
                        ...
                        <li class="feature-item">
                            <div class="feature-card">
                                <div class="card-icon">
                                    <img src="{{ asset('assets/images/Saladaicon.png') }}" width="100" height="80"
                                        loading="lazy" alt="icon">
                                </div>
                                <h3 class="title-2 card-title">Ingredientes Frescos e Naturais</h3>
                                <p class="label-1 card-text">Nossos pratos são preparados com os ingredientes mais
                                    frescos e naturais, para uma experiência culinária incomparável.</p>
                            </div>
                        </li>
                        ...
                        <li class="feature-item">
                            <div class="feature-card">
                                <div class="card-icon">
                                    <img src="{{ asset('assets/images/SustentavelIcon.png') }}" width="100" height="80"
                                        loading="lazy" alt="icon">
                                </div>
                                <h3 class="title-2 card-title">Compromisso com a Sustentabilidade</h3>
                                <p class="label-1 card-text">Cuidamos do planeta tanto quanto cuidamos do seu paladar.
                                    Comprometemo-nos a adotar práticas sustentáveis em tudo o que fazemos.</p>
                            </div>
                        </li>
                        ...
                        <li class="feature-item">
                            <div class="feature-card">
                                <div class="card-icon">
                                    <img src="{{ asset('assets/images/ChefIcon.png') }}" width="100" height="80"
                                        loading="lazy" alt="icon">
                                </div>
                                <h3 class="title-2 card-title">Inovação Gastronômica</h3>
                                <p class="label-1 card-text">Na Naturalle, a culinária é uma arte em constante evolução.
                                    Deixe-se surpreender por nossas criações gastronômicas únicas.</p>
                            </div>
                        </li>
                    </ul>

                    <img src="{{ asset('assets/images/shape-7.png') }}" width="208" height="178" loading="lazy"
                        alt="shape" class="shape shape-1">
                    <img src="{{ asset('assets/images/shape-8.png') }}" width="120" height="115" loading="lazy"
