...
<section class="quick-view">
   ...
   ?>
   <form action="" class="box" method="POST" style="background: black;">
      <div class="price">$<span><?= $fetch_products['price']; ?></span>/-</div>
      <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="">
      <div style="color: white;" class="name"><?= $fetch_products['name']; ?></div>
      <div style="color: white;" class="details"><?= $fetch_products['details']; ?></div>
