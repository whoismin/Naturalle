...
<section class="wishlist">
   ...
   <?php
      ...
      echo '<p class="empty">Não há nada aqui</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="shop.php" class="btn">Continue a compra</a>
      <a href="wishlist.php?delete_all" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Deletar produto</a>
   </div>
